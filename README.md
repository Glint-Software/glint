...
<img src=".github/assets/glint-logo.png" alt="Glint" width="300">
...
[Website](https://glint.dev) &nbsp;&bull;&nbsp; [Documentation](https://docs.glint.dev) &nbsp;&bull;&nbsp; [Discussions](https://github.com/glint-software/glint/discussions) &nbsp;&bull;&nbsp; [Issues](https://github.com/glint-software/glint/issues)
...
Download installers for Windows, macOS, and Linux from the **[Releases](https://github.com/glint-software/glint/releases)** page.

### Quick Start

1. Install and launch Glint.
...
Glint offers free and paid plans, including options for Glint Assist and included AI credits.

See **[glint.dev](https://glint.dev)** for current pricing, beta offers, plan details, and annual billing options.
...
Glint is closed-source proprietary software. We don't accept code contributions, but bug reports, feature ideas, and community feedback are very welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for details.
