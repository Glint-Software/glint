...
**Full Git Integration** &mdash; Stage, commit, push, pull, branch, and rebase from the UI. No terminal required (but it's there when you want it).
...
2. Open a local Git repository folder.
