...
Found a bug? Please file a [Bug Report](https://github.com/zide-software/Zide/issues/new?template=bug-report.yml). Include as much detail as possible:

- Steps to reproduce the issue
- Expected vs. actual behavior
- Zide version (found in Help > About)
...
If you discover a security vulnerability, **do not file a public issue.** Instead, please use GitHub's private vulnerability reporting via the [Security tab](https://github.com/zide-software/Zide/security). See our [Security Policy](SECURITY.md) for full details.
